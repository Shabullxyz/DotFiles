# Generated by Powerlevel10k configuration wizard on 2024-01-17 at 16:03 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    context                # exit code of the last command
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='󰒡'
